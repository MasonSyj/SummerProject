document.addEventListener('DOMContentLoaded', function() {
    ...
    let previous_data = JSON.parse(localStorage.getItem('dis_chart_data4'))
    ...
    setInterval(function() {
        ...
        lineChart.data.datasets[0].data.push(concentration)

        localStorage.setItem('dis_chart_data4', JSON.stringify(lineChart.data))
        lineChart.update();
    }, 2000);
});
