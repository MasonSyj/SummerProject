document.addEventListener('DOMContentLoaded', function() {
    ...
    let previous_data = JSON.parse(localStorage.getItem('dis_chart_data5'))
    ...
    setInterval(function() {
        ...
        lineChart.data.datasets[0].data.push(ph)

        localStorage.setItem('dis_chart_data5', JSON.stringify(lineChart.data))
        lineChart.update();
    }, 2000);
});
